...
$this->title = Yii::t('menu', 'Elements');
        ...
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ['content'=>
                    ...
                    ['role'=>'modal-remote','title'=> Yii::t('kvgrid', 'Create new Element'),'class'=>'btn btn-default']).
            ...
            'panel' => [
                'type' => 'primary', 
                'heading' => '<i class="glyphicon glyphicon-list"></i> ' . Yii::t('kvgrid', 'Elements listing'),
